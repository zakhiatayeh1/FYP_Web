...
CREATE TABLE `bike_category` (
  `bike_category_id` varchar(3) NOT NULL,
  `category_name` varchar(100) DEFAULT NULL,
  `byproduct_storage_id` int DEFAULT NULL,
  PRIMARY KEY (`bike_category_id`),
  KEY `fk_byproduct_storage` (`byproduct_storage_id`),
  CONSTRAINT `fk_byproduct_storage` FOREIGN KEY (`byproduct_storage_id`) REFERENCES `byproduct_storage` (`byproduct_storage_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `bike_category` VALUES ('1','A: fast production and/or  low demand',1),('2','B: average production and/or average demand',2),('3','C: high production and/or high demand',3);
